              ...
              <div className="">
                ...
                <div className="dacamentor-interview">
                  ...
                  <p>
                    <span className="dacamentor-response">
                      {
                        "The first day we crossed the border, and they took us to a very, very beautiful hotel in Los Angeles--very fancy with a lot of people walking around and a nice pool. It was very different to the ones I’ve stayed in Mexico. We went into our room and waited until our intermediate family came for us.  We were there for a couple hours until  my other aunt finally came for us, we went straight to Salinas. Once we got here, I met my mom and a younger sister who was born here. From there, I waited a week and half to get into school. "
                      }
                    </span>
                  </p>
                  <blockquote>
                ...
                <div className="dacamentor-interview">
                  ...
                  <p>
                    <span className="dacamentor-response">
                      {
                        "Yes, but I didn't know how much it would affect me until I was in my junior year in high school when students were doing worksheets on how to apply to a higher education as well as financial aid. One day during those workshops, they told us to go to FAFSA and fill out the application. I thought “Oh man, this is free money for school, okay!”. But my counselor said “Not you Jorge, you cannot apply to FAFSA. You cannot apply.” That's when it really hit me: the consequences and the effects of being an undocumented student."
                      }
                    </span>
                  </p>
                  <blockquote>
                ...
                <div className="dacamentor-interview">
                  ...
                  <p>
                    <span className="dacamentor-response">
                      {
                        "At that point, I wanted to be a teacher. I wanted to teach Spanish--not necessarily the grammar but the culture. I’m Mexican and I’m very proud of being from Mexico. I wanted to teach about Mexican history back then but the whole FAFSA issue threw my chances of higher education to the garbage or at least that is what I thought. When I graduated from high school,  I went straight to work in the fields. Right out of high school I worked in a local agricultural company by fixing agricultural pumps all over the Monterey County. I worked there for a couple weeks--it wasn't tough but it was physical work. My coworkers always encouraged me go back to school; they would tell me, “This is hard work, you don’t want to do this for the rest of your life, do something better.” I told my boss and his wife that I wanted to go back to school, and from that day on, they gave me less days, and less hours, until I had to leave because I wasn't making enough money. After that job over the summer, I started working in the fields as a irrigator. I worked there for a little more than a year: July to August. During the time, I was seeking help from friends to start school at my local community college. One day, I wrote a post on Facebook, and I asked for links and help to get back into school. One friend saw my posts, called me, and said she was going to help me fill out my application and all the paperwork I needed to do."
                      }
                    </span>
                  </p>
                </div>
                <div className="dacamentor-interview">
                  ...
                  <p>
                    <span className="dacamentor-response">
                      {
                        "Yes. At first I declared Spanish as my major but my experiences in the agriculture sector opened my eyes and notice the potential that I can provide to the agriculture industry. I changed my major and focused on crop production management."
                      }
                    </span>
                  </p>
                  <div className="dacamentor-interview">
                    ...
                    <p>
                      <span className="dacamentor-response">
                        {
                          "I transferred from Hartnell College. I knew I couldn't do much with my A.S. that I obtained so that motivated me to go further. In Hartnell you will hear in our department that the best schools to transfer were either Cal Poly or Fresno State. I applied to both and I got accepted to both as well. That is when I started to do more research and  asked students from those universities their perspective and evaluate which school would better fit for me. I reached out to one of my friends in Fresno, and he gave me a tour of the school, and the agriculture department, discover that Fresno State owns a a 1000 acre farm dedicated for students and staff for research. As I spoke with students, faculty members I received the support and that shaped my decision to finish my education here.. "
                        }
                      </span>
                    </p>
                  </div>
                  <div className="dacamentor-interview">
                    ...
                    <p>
                      <span className="dacamentor-response">
                        {
                          "It’s been really, really, really wonderful here in Fresno. I live very close to campus so I have greater time management. I hardly use my vehicle so I save money there too. I’m able to pay my bills. When it comes to school, the professors want you to succeed--they challenge students to make sure that they receive more than a certification but the skill needed to be in this industry. They want you to do the critical thinking, the analysis and the math--they want you do things right. Aside from taking my classes, I am active in three clubs: the dreamers beyond borders, trabajadores de la raza,  the plant science club. Dreamers beyond is a support group for AB-540 students and dreamers where we spread awareness of our situation. Trabajadores de la raza is a club to help the community. Plant science club is agricultural based to create support and networking with the students. Next semester, with the help of some students, I will start a farm operation to grow crops and donate it to the local food bank as part of a school project."
                        }
                      </span>
                    </p>
                    <blockquote>
                  ...
                  <div className="dacamentor-interview">
                    <p>
                      <b>
                        {
                          "Seems like you’re having a really good time. So far we’ve talked about the very beginning to now and you’re doing really great things for yourself and for others too. Let's talk a little more about the future. It’s a crazy time right now with a lot of uncertainty with DACA and for undocumented students like us. Where do you see yourself in the next few years if nothing crazy happens?"
                        }
                      </b>
                    </p>
                    <p>
                      <span className="dacamentor-response">
                        {
                          "I’ve envision two pathways for myself. My first pathway is to work back in my hometown, Salinas, CA with a local farmer. I plan on going back and working with him by being a manager for him so he can work on other activities to support the community. The reason why I want to work with him is because he has shown his values to support our local community and he has develop a voice and leadership that communities needs."
                        }
                      </span>
                    </p>
                    <p>
                      <span className="dacamentor-response">
                        {
                          "If pathway number 1 doesn’t work, I plan on opening my own company and be a consultant and provide irrigation training and irrigation management to farmers. Here in California, we have been  in a drought for a couple years and that is making people to conserve our water resources. I've had an internship opportunity where I gained a lot of practical knowledge and networked with Monterey County farmers, where I assisted them by providing information about conservation."
                        }
                      </span>
                    </p>
                    <p>
                  ...
                  <div className="dacamentor-interview">
                    ...
                    <p>
                      <span className="dacamentor-response">
                        {
                          "First of all I would really like to thank them for taking the time and doing this and acknowledging our situation. I know being a part of a political party and being involved in politics is difficult; I know the decision you make is made by the whole team. I am afraid of what the final agreement will look like. I just really want to thank them and hope they work on this and not create some DACA 2.0--we hope for something that in the long term won’t be removed.  "
                        }
                      </span>
                    </p>
                    <blockquote>
