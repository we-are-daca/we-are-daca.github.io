        ...
        return (
            ...
            <div className="container">
                ...
                <div className="row">
                    ...
                    <p>
                      <span className="dacamentor-response">
                          {'My parents wanted the best for us. I think the hardest part growing up was having to see my parents leave to work for hours to pick strawberries.  My father eventually landed a better job in construction when I was in middle school, therefore, it was a bit easier but still hard for my family. It was hard not seeing my parents when I was younger, they would wake up 4-5 in the morning and not come home until 8 at night. I spent most of my time with a babysitter. My mom said that was the hardest decision having to leave her children so early at 4am, having them spend the day with a complete stranger, but it had to be done to maintain a living for our family. At one point, my family lived in a three bedroom house with over eighteen people living there at the same time. Even the garage was rented out. It was people who barely came to the U.S from Mexico. We didn’t have any privacy, and all these certain things. I think that\'s where my motivation came from, seeing my parents work day-in-and-day-out, seeing the conditions we lived in and how it was slowly affecting my parents physically. '}
                      </span>
                    </p>
                    <p>
                      <span className="dacamentor-response">
                    ...
                    <p className="dacamentor-question">
                        <b>
                            {'Growing up were you aware of your status?'}
                        </b>
                    </p>
                    <p>
                      <span className="dacamentor-response">
                    ...
                    <p className="dacamentor-question">
                        <b>
                            {'Fast forward to now, you’re going to school, studying Physical Therapy. Let’s say nothing crazy happens; where do you see yourself in the next few years?'}
                        </b>
                    </p>
                    <p>
                      <span className="dacamentor-response">
                          {'I for sure want to go to graduate school. I’m working on my Bachelors in Kinesiology right now and I want to move my way up to getting into a Physical Therapy program. I’m looking into programs at both UC San Diego and Sacramento State, especially the latter since its closer to home. I was also looking into Fresnos program but I wouldn\'t like to live in Fresno. It’s too hot to be honest. I really don’t know how I’m going to approach my plan in connecting Physical Therapy and giving access to field workers. However, right now, I’m focusing on getting my education so that way I can be able to eventually connect the two. Baby steps.'}
                      </span>
                    </p>
                    <p className="dacamentor-question">
                        <b>
